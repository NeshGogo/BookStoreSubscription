...
namespace BookStoreSubscription.Migrations
{
    ...
    [Migration("20230408204004_invoices")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreSubscription.Entities.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStoreSubscription.Entities.Invoice", b =>
                {
                    ...
                    b.Property<DateTime>("PaydayLimitDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BookStoreSubscription.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("BookStoreSubscription.Entities.AuthorBook", b =>
                {
                    b.HasOne("BookStoreSubscription.Entities.Author", "Author")
                        .WithMany("AuthorBooks")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStoreSubscription.Entities.Book", "Book")
                        .WithMany("AuthorBooks")
            ...
            modelBuilder.Entity("BookStoreSubscription.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("BookStoreSubscription.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStoreSubscription.Entities.DomainRestriction", b =>
                {
                    b.HasOne("BookStoreSubscription.Entities.KeyAPI", "KeyAPI")
                        .WithMany("DomainRestrictions")
                        .HasForeignKey("KeyAPIId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
